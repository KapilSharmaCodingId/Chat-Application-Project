...
static JFrame f = new JFrame();
        public User(){
            ...
            ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("images/1.png"));  //to take the image from file 
           ...
           JLabel name = new JLabel("Shanju Kumar");    //add any name or content in out frame 
        ...
        //    new JTextField();
            ...
            f.setLocation(200,40);          // to set the location of frame
    ...
    public static void main(String[] args) {
         ...
         try{
                ServerSocket skt = new ServerSocket(12084);    //Create server
                while(true){
                    Socket s = skt.accept();
